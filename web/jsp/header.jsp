        ...
        <nav class="navbar navbar-inverse barra">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">CORTSEM</a>
                </div>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="#"><span class="glyphicon glyphicon-user loguito"></span>REGISTRASE</a></li>
                   
                    <li><a href="login.jsp"><span class="glyphicon glyphicon-log-in loguito">
